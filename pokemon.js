...
var pokemonDisplay=function(pokemonName){		//taking input in parameter

for (var arrayPokemon in jsonPokemon.pokemon){
if(jsonPokemon.pokemon[arrayPokemon].name ==pokemonName) 		//checking input in for loop with pokemon next evaloution element
{
console.log(jsonPokemon.pokemon[arrayPokemon]);
break;
}		// end of if condition
...
pokemonUserName=window.prompt("please enter a pokemon name for pokemon details ");//taking a input from user
pokemonDisplay(pokemonUserName);//passing the input in argument



var pokemonNextEvoloutionDisplay=function(pokemonName){ 		//taking input in parameter
for (var arrayPokemon in jsonPokemon.pokemon){
for (var arrayNextEvolution in jsonPokemon.pokemon[arrayPokemon].next_evolution){

if(jsonPokemon.pokemon[arrayPokemon].next_evolution[arrayNextEvolution].name ==pokemonName) 	//checking input in for loop with pokemon next evaloution element
{
console.log(jsonPokemon.pokemon[arrayPokemon].name);
break;
...
var pokemonNextEvolution=window.prompt("please enter a pokemon name for find name in next evolution field"); 		//taking a input from user
pokemonNextEvoloutionDisplay(pokemonNextEvolution);		//passing the input in argument


var pokemonWeaknesssDisplay=function(pokemonWeakness){
for (var arrayPokemon in jsonPokemon.pokemon){
for (var arrayWeakness in jsonPokemon.pokemon[arrayPokemon].weaknesses){

if(jsonPokemon.pokemon[arrayPokemon].weaknesses[arrayWeakness] ==pokemonWeakness)  //checking input in for loop with pokemon weakness element
{
console.log(jsonPokemon.pokemon[arrayPokemon].name);
break;
}  			// end of if condition
...
var pokemonUserWeakness=window.prompt("please enter a  weakness name "); 	//taking a input from user
pokemonWeaknesssDisplay(pokemonUserWeakness);  		//passing the input in argument
